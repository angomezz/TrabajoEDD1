...
class App:
    def __init__(self, root):
        ...
        self.v_principal.config(bg='pink')
        self.v_principal.geometry('600x400+40+40')
        self.v_principal.resizable(0, 0)
        self.v_principal.title('Pagina Principal')

        # Crear frame1
        frame1 = Frame(self.v_principal, width=600, height=70, bg="SlateGray2")
        ...
        #crear frame2
        frame2 = Frame(self.v_principal, width=600, height=230, bg="white")
        ...
        titulo_puntaje = Label(frame2, text="45", width=15, font=("Arial", 14))
        titulo_puntaje.place(relx=0.65, rely=0.3)

        #crear frame3
        frame3 = Frame(self.v_principal, width=600, height=230, bg="white")
        ...
        bot1=Button(frame3,  text="4 letras", command=self.ejecutar_main,bg="#80FF00")
